...
from chunking.core.config import (
    MASTER_OUTPUT_DIR, QA_MASTER_DIR, TIMESTAMP_FORMAT, FINAL_OUTPUT_DIR
)
...
def main() -> None:
    ...
    output_path = os.path.join(FINAL_OUTPUT_DIR, f"final_chunks_{timestamp}.json")
    symlink_path = os.path.join(FINAL_OUTPUT_DIR, "final_chunks.json")
